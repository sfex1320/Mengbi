...
import { registerStarVectorFeature } from './starvector';
...
export function registerBuiltinAiFeatures(): void {
  ...
  registerStarVectorFeature();
  logger.info('[ai-platform] builtin features registered: hypir, supir, starvector');
}
...
export type { StarVectorSubmitInput } from './starvector';
